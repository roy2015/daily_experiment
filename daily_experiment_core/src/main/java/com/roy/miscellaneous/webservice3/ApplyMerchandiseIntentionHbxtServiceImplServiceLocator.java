...
public class ApplyMerchandiseIntentionHbxtServiceImplServiceLocator extends org.apache.axis.client.Service implements ApplyMerchandiseIntentionHbxtServiceImplService {
    ...
    public ApplyMerchandiseIntentionHbxtService getApplyMerchandiseIntentionHbxtServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.roy.miscellaneous.webservice3.ApplyMerchandiseIntentionHbxtServiceImplServiceSoapBindingStub _stub = new com.roy.miscellaneous.webservice3.ApplyMerchandiseIntentionHbxtServiceImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ApplyMerchandiseIntentionHbxtService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.roy.miscellaneous.webservice3.ApplyMerchandiseIntentionHbxtServiceImplServiceSoapBindingStub _stub = new com.roy.miscellaneous.webservice3.ApplyMerchandiseIntentionHbxtServiceImplServiceSoapBindingStub(new java.net.URL(ApplyMerchandiseIntentionHbxtServiceImplPort_address), this);
                _stub.setPortName(getApplyMerchandiseIntentionHbxtServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
