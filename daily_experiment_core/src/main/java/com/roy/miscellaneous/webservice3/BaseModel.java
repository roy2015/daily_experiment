...
public class BaseModel  extends Model  implements java.io.Serializable {
    private com.roy.miscellaneous.webservice3.BaseModelFieldMapEntry[] fieldMap;

    public BaseModel() {
    }

    public BaseModel(
           com.roy.miscellaneous.webservice3.BaseModelFieldMapEntry[] fieldMap) {
     ...
     * @return fieldMap
     */
    public com.roy.miscellaneous.webservice3.BaseModelFieldMapEntry[] getFieldMap() {
        return fieldMap;
    }
     ...
     * @param fieldMap
     */
    public void setFieldMap(com.roy.miscellaneous.webservice3.BaseModelFieldMapEntry[] fieldMap) {
        this.fieldMap = fieldMap;
    }
