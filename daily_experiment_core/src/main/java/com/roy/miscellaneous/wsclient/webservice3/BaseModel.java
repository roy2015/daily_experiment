...
public class BaseModel  extends Model  implements java.io.Serializable {
    private com.roy.miscellaneous.wsclient.webservice3.BaseModelFieldMapEntry[] fieldMap;
     ...
     * @return fieldMap
     */
    public com.roy.miscellaneous.wsclient.webservice3.BaseModelFieldMapEntry[] getFieldMap() {
        return fieldMap;
    }
     ...
     * @param fieldMap
     */
    public void setFieldMap(com.roy.miscellaneous.wsclient.webservice3.BaseModelFieldMapEntry[] fieldMap) {
        this.fieldMap = fieldMap;
    }
