...
public class TestSolution208 {
     ...
     * trie树（前缀树），常用于推荐系统
     *
     * 虽然说参考了网上的思路 {@link https://blog.csdn.net/weixin_39778570/article/details/81990417 }，但优化了他的写死的二维数组长度，用了javad的变长，<p>
     *     代码逻辑也是自己思考出来的，算是原创吧 变长还是引发一连串算法设计的，比如扩容，关键是要有图化的想象力，get了
     *
     * 执行结果：
     * 通过
     * 显示详情
