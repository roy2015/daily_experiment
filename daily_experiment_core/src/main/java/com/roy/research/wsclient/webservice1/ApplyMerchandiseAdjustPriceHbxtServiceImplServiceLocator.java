...
public class ApplyMerchandiseAdjustPriceHbxtServiceImplServiceLocator extends org.apache.axis.client.Service implements ApplyMerchandiseAdjustPriceHbxtServiceImplService {
    ...
    public ApplyMerchandiseAdjustPriceHbxtService getApplyMerchandiseAdjustPriceHbxtServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.roy.research.wsclient.webservice1.ApplyMerchandiseAdjustPriceHbxtServiceImplServiceSoapBindingStub _stub = new com.roy.research.wsclient.webservice1.ApplyMerchandiseAdjustPriceHbxtServiceImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ApplyMerchandiseAdjustPriceHbxtService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.roy.research.wsclient.webservice1.ApplyMerchandiseAdjustPriceHbxtServiceImplServiceSoapBindingStub _stub = new com.roy.research.wsclient.webservice1.ApplyMerchandiseAdjustPriceHbxtServiceImplServiceSoapBindingStub(new java.net.URL(ApplyMerchandiseAdjustPriceHbxtServiceImplPort_address), this);
                _stub.setPortName(getApplyMerchandiseAdjustPriceHbxtServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
