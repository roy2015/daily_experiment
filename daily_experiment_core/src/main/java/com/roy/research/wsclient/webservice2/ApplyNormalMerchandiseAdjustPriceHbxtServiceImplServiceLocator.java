...
public class ApplyNormalMerchandiseAdjustPriceHbxtServiceImplServiceLocator extends org.apache.axis.client.Service implements ApplyNormalMerchandiseAdjustPriceHbxtServiceImplService {
    ...
    public ApplyNormalMerchandiseAdjustPriceHbxtService getApplyNormalMerchandiseAdjustPriceHbxtServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.roy.research.wsclient.webservice2.ApplyNormalMerchandiseAdjustPriceHbxtServiceImplServiceSoapBindingStub _stub = new com.roy.research.wsclient.webservice2.ApplyNormalMerchandiseAdjustPriceHbxtServiceImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ApplyNormalMerchandiseAdjustPriceHbxtService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.roy.research.wsclient.webservice2.ApplyNormalMerchandiseAdjustPriceHbxtServiceImplServiceSoapBindingStub _stub = new com.roy.research.wsclient.webservice2.ApplyNormalMerchandiseAdjustPriceHbxtServiceImplServiceSoapBindingStub(new java.net.URL(ApplyNormalMerchandiseAdjustPriceHbxtServiceImplPort_address), this);
                _stub.setPortName(getApplyNormalMerchandiseAdjustPriceHbxtServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
