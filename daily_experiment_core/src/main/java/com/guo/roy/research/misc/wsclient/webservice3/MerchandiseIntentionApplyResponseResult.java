...
public class MerchandiseIntentionApplyResponseResult  implements java.io.Serializable {
    private com.guo.roy.research.misc.wsclient.webservice3.MerchandiseIntention data;
    ...
    public MerchandiseIntentionApplyResponseResult(
           com.guo.roy.research.misc.wsclient.webservice3.MerchandiseIntention data,
           String message,
           boolean sucess) {
           this.data = data;
     ...
     * @return data
     */
    public com.guo.roy.research.misc.wsclient.webservice3.MerchandiseIntention getData() {
        return data;
    }
     ...
     * @param data
     */
    public void setData(com.guo.roy.research.misc.wsclient.webservice3.MerchandiseIntention data) {
        this.data = data;
    }
