 ...
 * 
 *   第三种方式，比较好理解，用两个BlockingQueue
 */
@Slf4j
public class TestPrint12A5152z_3 {
    ...
    public TestPrint12A5152z_3() {
        this.queueA = new LinkedBlockingQueue<>(1);
        this.queueB = new LinkedBlockingQueue<>(1);
