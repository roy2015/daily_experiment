...
public class BaseModel  extends Model  implements java.io.Serializable {
    private com.guo.roy.research.misc.wsclient.webservice3.BaseModelFieldMapEntry[] fieldMap;

    public BaseModel() {
    }

    public BaseModel(
           com.guo.roy.research.misc.wsclient.webservice3.BaseModelFieldMapEntry[] fieldMap) {
     ...
     * @return fieldMap
     */
    public com.guo.roy.research.misc.wsclient.webservice3.BaseModelFieldMapEntry[] getFieldMap() {
        return fieldMap;
    }
     ...
     * @param fieldMap
     */
    public void setFieldMap(com.guo.roy.research.misc.wsclient.webservice3.BaseModelFieldMapEntry[] fieldMap) {
        this.fieldMap = fieldMap;
    }
